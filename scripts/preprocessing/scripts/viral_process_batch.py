...
MIN_LEN = 500       # Threshold lowered to avoid over-deleting the viral group
MAX_AMBIG = 0.05
CDHIT_ID = 0.99
MIN_CONTIGS = 1     # For this group, there is mostly 1 contig in each file!
CDHIT_THREADS = 4
...
with ThreadPoolExecutor(max_workers=MAX_WORKERS) as executor:
    futures = [executor.submit(process_file, f) for f in slice_files]
